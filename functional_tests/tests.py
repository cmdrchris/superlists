...
class NewVisitorTest(LiveServerTestCase):
    ...
    def test_can_start_a_list_and_retrieve_it_later(self):
        ...
        # to check out its homepage browser.get(' http:// localhost: 8000')
        ...
        # She visits that URL - her to-do list is still there. # Satisfied, she goes back to sleep browser.quit()
